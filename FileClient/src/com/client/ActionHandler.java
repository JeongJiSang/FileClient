...
//			}
			...
			// 채팅화면
			/*
			 * else if(obj.equals(chatView.jbtn_send)) { client.send(Protocol.sendMessage,
			 * chatView.jtf_msg.getText()); }
			 */
			// 중간입장
	...
	public void getroomName() {
		int[] selectRoom = defView.jtb_room.getSelectedRows();
		for(int room: selectRoom) {
			String roomName = defView.jtb_room.getValueAt(room,0).toString();
